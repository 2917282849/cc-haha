  ...
  useInput((input, key) => {
    ...
    if (input === 's') {
      if (dialogLevel.type === 'teammateList' && teammateStatuses[selectedIndex]) {
        ...
        void sendShutdownRequestToMailbox(teammate.name, dialogLevel.teamName, '团队负责人请求优雅关闭');
      } else if (dialogLevel.type === 'teammateDetail' && currentTeammate) {
        void sendShutdownRequestToMailbox(currentTeammate.name, dialogLevel.teamName, '团队负责人请求优雅关闭');
        goBackToList();
      }
      return;
    }
